...
exports.getMaterialComponents = void 0;
var getMaterialComponents = function (speech) {
    var source = speech.split(' ').reverse()[0];
    switch (source) {
        case 'babu':
            return [
                'babu leg bone',
...
exports.getMaterialComponents = getMaterialComponents;
